...
class ModelTraining:
    def __init__(self):
        ...
        self.model = DecisionTreeClassifier(criterion="gini" , max_depth=30 , random_state=54)
    ...
    def evaluate_model(self,X_test,y_test):
        try:
            ...
            sns.heatmap(cm , annot=True , cmap="Oranges" , xticklabels=np.unique(y_test) , yticklabels=np.unique(y_test))
